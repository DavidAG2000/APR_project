...
train_dataset, val_dataset = training_dataset,test_dataset
...
epochsizes =[50] 
for epochsize in epochsizes:
    print("Tamaño de epocas: %s" % (epochsize))
    ...
    intervalo = 1.96* math.sqrt((err * (1-err))/len(val_dataset))
    print("Intervalo : %2f%%" % (intervalo*100))
